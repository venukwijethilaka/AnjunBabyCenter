    ...
    <div className="flex gap-2 justify-center">
      {otp.map((_, index) => (
        <input
          ...
          onPaste={handlePaste}
          // ✅ CHANGED: focus:border-pink-500 focus:ring-pink-200
          className="w-12 h-12 text-center text-xl font-bold border border-gray-300 rounded-lg focus:border-pink-500 focus:ring-2 focus:ring-pink-200 outline-none transition-all text-gray-900 bg-white"
        />
      ))}
    </div>
  );
