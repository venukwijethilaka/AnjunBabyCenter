 ...
 * `prisma.loyaltyLevel`: Exposes CRUD operations for the **LoyaltyLevel** model.
  ...
  * ```
  */
    get loyaltyLevel(): Prisma.LoyaltyLevelDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.promotionalOffer`: Exposes CRUD operations for the **PromotionalOffer** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more PromotionalOffers
      * const promotionalOffers = await prisma.promotionalOffer.findMany()
      * ```
      */
    get promotionalOffer(): Prisma.PromotionalOfferDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
