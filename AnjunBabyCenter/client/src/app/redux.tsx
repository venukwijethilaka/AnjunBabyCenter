...
const persistConfig = {
  key: "root",
  storage,
  whitelist: ["global"], // Keep only UI settings persisted automatically
};
...
export default function StoreProvider({ children }: { children: React.ReactNode }) {
  ...
  if (!storeRef.current) {
    ...
    if (typeof window !== "undefined") {
      ...
      // ✅ FIX: Added check to ignore "undefined" or "null" strings
      if (userStr && token && userStr !== "undefined" && userStr !== "null") {
        try {
