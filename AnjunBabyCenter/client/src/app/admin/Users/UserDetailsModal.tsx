...
const UserDetailsModal = ({ isOpen, onClose, user }: UserDetailsModalProps) => {
 ...
 const totalSpent = user.orders?.reduce((sum, order) => sum + Number(order.totalAmount || 0), 0) || 0;
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 col-span-2 flex justify-between items-center px-6">
                        <div className="flex flex-col">
                            ...
                            <span className="text-green-600 font-bold text-xl">Rs. {totalSpent.toFixed(2)}</span>
                        </div>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {user.orders.map((order) => (
                                <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">Rs. {order.totalAmount.toFixed(2)}
                                    </td>
