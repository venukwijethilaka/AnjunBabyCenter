...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    // ✅ CHANGED: Now uses theme-primary for background and shadow!
    primary: "bg-theme-primary text-white hover:opacity-90 shadow-lg shadow-theme-primary/30 active:scale-[0.98]",
