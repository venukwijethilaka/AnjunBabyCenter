    ...
    <div className="fixed inset-0 z-[100] overflow-hidden">
      ...
      {notification && (
        <div className={`fixed top-6 right-6 px-6 py-3 rounded-lg shadow-2xl z-[110] border transition-all animate-in fade-in slide-in-from-top-4 ${
          notification.type === 'success' ? 'bg-theme-toggle-bg border-theme-border text-theme-primary' : 'bg-rose-50 border-rose-200 text-rose-700'
        }`}>
          ...
          <div className="flex h-full flex-col bg-white shadow-2xl">
            ...
            <div className="border-t border-gray-100 bg-white p-6 space-y-4">
              ...
              <button 
                ...
                className="w-full bg-theme-primary hover:bg-theme-bg-hover text-white py-4 rounded-xl font-bold transition-all shadow-md active:scale-[0.99] flex items-center justify-center gap-2"
              >
